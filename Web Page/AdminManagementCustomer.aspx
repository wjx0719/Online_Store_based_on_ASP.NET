<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminManagementCustomer.aspx.cs" Inherits="Web_Page.AdminManagementCustomer" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title></title>
    <link rel="stylesheet" type="text/css" href="css/AdminManagementCustomer.css" />
</head>
<body>
                ...
                <div class="infobox">
                    ...
                    <div class="btnrow">
                        <div class="leftbtnwrapper">
                            <asp:Button ID="Button1" runat="server" Text="上一个顾客" class="leftbtn" OnClick="Button1_Click"/>
                        </div>
                        <div class="pageinfo">
                            <asp:Label ID="Label1" runat="server" Text=""></asp:Label>
                        </div>
                        <div class="rightbtnwrapper">
                            <asp:Button ID="Button3" runat="server" Text="下一个顾客" class="rightbtn" OnClick="Button3_Click"/>
                        </div>
                        <div class="floatclear"></div>
                    </div>
                </div>
