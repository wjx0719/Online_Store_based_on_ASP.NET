<%@ Page Language="C#" AutoEventWireup="true" Inherits="Web_Page.StoreRegister" Codebehind="StoreRegister.aspx.cs" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title></title>
    <link rel="stylesheet" type="text/css" href="css/StoreRegister.css" />
</head>
<body>
        ...
        <div class="wrapper">
            ...
            <div class="rightwrapper">
                <div class="registerbox">
                    <div class="title">店铺注册</div>
                    <div class="tablerow">
                        <input id="Name" type="text" runat="server" class="textbox" placeholder="店铺名（必填，用于登陆系统）" />
                    </div>
                    <div class="tablerow">
