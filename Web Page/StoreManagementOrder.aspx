<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StoreManagementOrder.aspx.cs" Inherits="Web_Page.StoreManagementOrder" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title></title>
    <link rel="stylesheet" type="text/css" href="css/StoreManagementOrder.css" />
</head>
<body>
                ...
                <div class="infobox">
                    ...
                    <div class="cardbox">
                        ...
                        <div class="infocard">
                            ...
                            <div class="infotitle">顾客姓名</div>
                            <div class="customername">
                                <asp:Label ID="CustomerName" runat="server" Text=""></asp:Label>
                            </div>
                            <div class="infotitle">顾客电话</div>
                            <div class="phone">
                                <asp:Label ID="Phone" runat="server" Text=""></asp:Label>
                            </div>
                            <div class="infotitle">顾客邮箱</div>
                            <div class="email">
                                <asp:Label ID="Email" runat="server" Text=""></asp:Label>
                            </div>
                            <div class="infotitle">顾客住址</div>
                            <div class="address">
