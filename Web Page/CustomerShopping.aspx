<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerShopping.aspx.cs" Inherits="Web_Page.CustomerShopping" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title></title>
    <link rel="stylesheet" type="text/css" href="css/CustomerShopping.css" />
</head>
<body>
    <form id="form1" runat="server">
        ...
        <div class="wrapper">
            ...
            <div class="rightwrapper">
                <div class="infobox">
                    <div class="title">商城首页</div>
                    <div class="searchbar">
                        <div class="searchboxwrapper">
                            <input id="Search" type="text" runat="server" class="searchbox"/>
                        </div>
                        <div class="searchbtnwrapper">
                            <asp:Button ID="Button4" runat="server" Text="搜索" OnClick="Button4_Click" class="searchbtn"/>
                        </div>
                    ...
                    <div class="cardbox">
                        ...
                        <div class="infocard">
                            ...
                            <div class="opbtnwrapper">
                                <asp:Button ID="Button5" runat="server" Text="加入订单" OnClick="Button5_Click"  class="opbtn"/>
                            </div>
                        </div>
                        <div class="floatclear"></div>
                        <div class="btnrow">
