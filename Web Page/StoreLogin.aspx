<%@ Page Language="C#" AutoEventWireup="true" Inherits="Web_Page.StoreLogin" Codebehind="StoreLogin.aspx.cs" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title></title>
    <link rel="stylesheet" type="text/css" href="css/StoreLogin.css" />
</head>
<body>
    <form id="form1" runat="server">
        ...
        <div class="wrapper">
            ...
            <div class="rightwrapper">
                <div class="loginbox">
                    <div class="title">店铺登陆</div>
                    <div class="tablerow">
                        <input id="Name" type="text" runat="server" class="textbox" placeholder="店铺名" />
                    </div>
                    <div class="tablerow">
