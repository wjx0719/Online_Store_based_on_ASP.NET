<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StoreModifyProduct.aspx.cs" Inherits="Web_Page.StoreModifyProduct" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title></title>
    <link rel="stylesheet" type="text/css" href="css/StoreModifyProduct.css" />
</head>
<body>
                ...
                <div class="infobox">
                    ...
                    <div class="cardbox">
                        ...
                        <div class="btnrow">
                            ...
                            <asp:Button ID="Button3" runat="server" Text="确认修改" OnClick="Button3_Click" class="btn"/>
                            </div>
                        </div>
                    </div>
                </div>
