<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminManagementProduct.aspx.cs" Inherits="Web_Page.AdminManagementProduct" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title></title>
    <link rel="stylesheet" type="text/css" href="css/AdminManagementProduct.css" />
</head>
<body>
                ...
                <div class="infobox">
                    ...
                    <div class="cardbox">
                        ...
                        <div class="infocard">
                            ...
                            <div class="infotitle">浏览次数</div>
                            <div class="viewtimes">
                                <asp:Label ID="Viewtimes" runat="server" Text=""></asp:Label>
                            </div>
                        </div>
